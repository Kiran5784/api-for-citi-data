...
app.get('/getCarsOptions',async (req, res)=>{
    const result = {
        brandList : [
            ...
            {brand: 'Kia',
              models: ['Seltos', 'Sonet', 'Carnival', 'Sportage']},
            {brand: 'Hyundai',
            ...
            {brand: 'Renault',
              models: ['Kwid', 'Duster', 'Triber', 'Captur']},
            {brand: 'Volkswagen',
              models: ['Polo', 'Vento', 'Tiguan', 'Passat']},
            {brand: 'Chevrolet',
              models: ['Cruze', 'Beat', 'Trailblazer', 'Sail']},
            {brand: 'Fiat',
              models: ['Punto', 'Linea', '500']}
          ],
        makeYear : [2023,2022,2021,2020,2019,2018,2017,2016,2015,2014,2013,2012,2011],
        variants : ['Petrol','Diesel','CNG'],
        kmDriven : ["0 - 10,000 Km","10,000 - 20,000 km","20,000 - 30,000 Km","30,000 - 40,000 Km","40,000 - 50,000 Km",
        "Above 50,000 km"],
        features : ["Infotainment system","Airbags","steering mounted controls","Parking sensors","Alloy wheels",
        "Push button start","Sunroof/moonroof"],
        transmissions : ["manual","automatic"],
        bodyTypes : ["Hatchback","Sedan","suv"],
        colors : ["Silver","white","Red","Blue","Brown","Orange","Black","Yellow","Green","Purple"],
        seats : ["4 Seater","5 Seater","6 Seater","7 Seater"],
        owners : ["1st owner","2nd owner","3rd owner"],
        states : [{state : 'Maharashtra', codes : ['MH-12','MH-14','MH-01','MH-13']},
